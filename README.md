...
## Assumptions
Below are the assumptions I made.
- Direct reports never form an infinite loop. i.e John reports to Paul and Paul Reports to John.
- There is no minimum information needed to create a new Employee/Compensation. i.e No first and last names are required
